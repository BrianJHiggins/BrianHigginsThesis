...
# Module_1
# Web scrapes list of transcripts on the Seeking Alpha website
...
# # Module_2  - Superseded by below
# # Extracting the individual S&P500 transcripts
# # requires file 'transcripts_list_data.csv'
#
# import csv
# from selenium import webdriver
# from bs4 import BeautifulSoup
...
# and using the 'id' values marked as 'S&P_500' in the (endpoint) url
...
# Module_3B
# splits the Q&A section into individual questions and answers and cleans
# the text of greetings phrases and words
