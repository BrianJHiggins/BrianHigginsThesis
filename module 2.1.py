...
# output_filename = './ECC_FinBERT_sentiment_output.csv'
output_filename = 'ECC_FinBERT_sentiment_output.csv'

# df = pd.read_csv(
#     '/kaggle/input/transcripts-questions-answers-test-cleaned-7-csv/Transcripts_Questions_Answers_Test_cleaned_7.csv',
#     encoding='utf-8')
#df = pd.read_csv('/kaggle/input/ecc-finbert-input-csv/ECC_FinBERT_Input.csv',encoding='utf-8')
df = pd.read_csv('ECC_FinBERT_Input.csv',encoding='utf-8')
